<?php
    ...
    $query .= "CREATE TABLE Ads (adID INT not null auto_increment,title
                VARCHAR(30) not null,url VARCHAR(100) not null, description
                VARCHAR(500) not null, PRIMARY KEY(adID));";
    ...
    $query .= "INSERT INTO ads(title, url, description) VALUES
                ('First ad','www.somewhere1.com','First ad ever!');";
    $query .= "INSERT INTO ads(title, url, description) VALUES
                ('Second ad','www.somewhere2.com','Here is second ad!');";
    $query .= "INSERT INTO ads(title, url, description) VALUES
                ('Third ad','www.somewhere3.com','This is the third ad!');";
