<?php
    ...
    $query .= "CREATE TABLE News (ID INT not null auto_increment,title VARCHAR(30) not null, url VARCHAR(150) not null, content VARCHAR(300) not null, PRIMARY KEY(ID));";
    $query .= "INSERT INTO News(title,url,content) VALUES ('Yoga Tablet', 'http://www.engadget.com/2013/11/17/the-yoga-tablet-does-kickstands-with-a-twist/', 'If one takes a narrow view of the tablet market.');";
    $query .= "INSERT INTO News(title,url,content) VALUES ('Playstation4', 'http://www.engadget.com/2013/11/17/sony-sells-over-1-million-playstation-4-consoles-in-first-day/', 'Sony sells over 1 million PlayStation 4 console.');";
    ...
    $query .= "INSERT INTO News(title,url,content) VALUES ('LG Flex', 'http://www.engadget.com/2013/11/15/lg-g-flex-att-lte/', 'LG G Flex appears on the FCC with ATT-friendly LTE');";
    ...
    $query .= "INSERT INTO News(title,url,content) VALUES ('Microsoft', 'http://www.engadget.com/2013/11/15/steve-ballmer-explains-retirement-decision/', 'Steve Ballmer couldnt change Microsoft fast enough');";
