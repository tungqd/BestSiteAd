<?php
    ...
    'http://www.engadget.com/2013/11/16/oxford-university-scientists-break-
    qubit-survival-record-are-on/', 'Experiment brings quantum computing 
    ...
    'http://www.engadget.com/2013/11/15/lg-g-flex-att-lte/', 'LG G Flex appears 
    on the FCC with ATT-friendly LTE');";
    $query .= "INSERT INTO News(title,url,content) VALUES ('London', 
    'http://www.engadget.com/2013/11/15/london-city-tld/', 'London becomes the 
    latest city to get its own top-level domain');";
    ...
    'http://www.engadget.com/2013/11/15/almost-all-of-your-notifications-can-
    now-display-on-galaxy-gear/','Almost all of your notifications can now 
    display.');";
    $query .= "INSERT INTO News(title,url,content) VALUES ('Microsoft', 
    'http://www.engadget.com/2013/11/15/steve-ballmer-explains-retirement-
    decision/', 'Steve Ballmer couldnt change Microsoft fast enough');";
